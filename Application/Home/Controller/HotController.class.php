...
class HotController extends BaseController {
	...
	public function index() {
		...
		$page_str = str_replace('/home/hot/index/p/', '/hot/index_', strtolower($page -> show()));
	...
	public function week() {
		...
		$this -> assign('user_joke', $user_joke);
		$page_str = str_replace('/home/hot/week/p/', '/hot/week_', strtolower($page -> show()));
		$this -> assign('page', $page_str);
		$this -> getseo('week');
		$this -> display();
	} 
	public function month() {
		...
		$this -> assign('user_joke', $user_joke);
		$page_str = str_replace('/home/hot/month/p/', '/hot/month_', strtolower($page -> show()));
		$this -> assign('page', $page_str);
		$this -> getseo('month');
		$this -> display();
	} 
